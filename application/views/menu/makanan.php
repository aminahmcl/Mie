<div id="preloader">
    <div class="loader-content">
        ...
        <p class="loading-text">MEMUAT MENU MAKANAN...</p>
    </div>
</div>
...
<section class="catalog-hero">
    <div class="container text-center">
        ...
        <h1>Katalog Makanan</h1>
        <p class="hero-desc">
            Pilihan mie ayam lezat dengan cita rasa gurih dan bahan segar setiap hari.
        </p>
    </div>
</section>
